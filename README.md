...
Getting started:
=============
* Download the binaries ([x64](https://github.com/Francesco149/OpenTwitchPlays/releases/download/r2/OpenTwitchPlays-r2_x64.zip) or [x86](https://github.com/Francesco149/OpenTwitchPlays/releases/download/r2/OpenTwitchPlays-r2_x86.zip)) and make sure you have the .NET Framework version 4.0 or higher.
